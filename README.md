...
| 2 | Qwen3-max          | 0.68  | 
| 3 | Gemini-2.5-pro+rag | 0.72  | 

### Ensemble模型：

| # | 模型1            | 比例  | 模型2         | 比例  | 模型3       | 比例  | Score |
|:--|:---------------|:----|:------------|:----|:----------|:----|:------|
| 1 | Gemini-2.5-pro | 0.6 | e5-large-v2 | 0.4 | -         | -   | 0.73  |
| 1 | Gemini-2.5-pro | 0.4 | e5-large-v2 | 0.3 | Qwen3-max | 0.3 | 0.71  |
